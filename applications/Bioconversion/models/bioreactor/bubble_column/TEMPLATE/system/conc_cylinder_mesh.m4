...
define(vlabel, [[// ]Vertex $1 = VCOUNT define($1, VCOUNT)define([VCOUNT], incr(VCOUNT))])
   ...
   define(D1, ##VARIABLE_COLUMN_DIAMETER##)   // outer cylinder diameter
   define(L1, ##VARIABLE_COLUMN_HEIGHT##)  // outer cylinder length

   define(D2, calc(0.707*D1))   //  inner cylinder diameter
   define(L2, ##VARIABLE_INNER_COLUMN_HEIGHT##)  //  inner cylinder length
