...
pltline1.Source.Point1 = [0.5*(ptsmin[0]+ptsmax[0]), 0.5*(ptsmin[1]+ptsmax[1]),ptsmin[2]]
pltline1.Source.Point2 = [0.5*(ptsmin[0]+ptsmax[0]), 0.5*(ptsmin[1]+ptsmax[1]),ptsmax[2]]
